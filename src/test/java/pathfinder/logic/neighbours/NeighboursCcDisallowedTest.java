...
public class NeighboursCcDisallowedTest {
    ...
    public void setUp() {
        ...
        // For these tests we do NOT allow corner-cutting
        neighbours = new Neighbours(g, false);
    }

    @Test
    public void preventsCornerCutting() {
        ...
        List<Node> n = neighbours.getNeighbours(5, 5); // Still, diagonal neighbours should not be returned
